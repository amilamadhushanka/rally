...
<body>
<form role = "form" method = "post" action = "createNewTeam">
<div id="container">
...
<tr>
  <td bgcolor="#D63030"><label> User Name : </label></td>
  <td>
      <select name ="UserName" style="width:450px" value="<?php echo set_select('UserName');?>">
   <?php
            $con = mysql_connect("localhost","root","")or die("cannot connect");
            if (!$con)   
            {     
 ...
 <td>Ex : ABCD@Company.lk</td>
</tr>


<tr>
  <td bgcolor=" #F0F8FF"> <label> Disabled </label></td>
  <td><input type="checkbox"  name="Disable" value="disable" <?php echo set_checkbox('Disable', 'disable'); ?> /></td> 

<tr><td bgcolor="#F0F8FF">Name:</td>
 ...
 <tr>
    ...
    <td><input type="text" id="FirstName" name="FirstName"  value="<?php echo set_value('FirstName');?>" style="width:200px" ></td> 
    
         
    <td><input type="text" id="lastName" name="LastName" value="<?php echo set_value('LastName');?>" style="width:200px" ></td>
...
<tr bgcolor="#F0F8FF">&nbsp;</tr>
 <tr><td bgcolor="#F0F8FF">Role: </td>
 
<td>
<select name="role"value="<?php echo set_select('role');?>">
    
                <option value="No entry" selected>
                    «No Entry»
                </option>
...
<tr>
<td  class = "spaced" bgcolor="#F0F8FF">  Office Location:
</td>
<td>
<select name="location" value="<?php echo set_select('location');?>">
    
                <option value="No Entry" selected>
                    «No Entry»
                </option>
                <option value="Location 01" selected>
                    Location 01
                </option>
                <option value="Location 02" selected>
                    Location 02
                </option>
                <option value="Location 03" selected>
                    Location 03
                </option>
 ...
 <tr><td bgcolor=" #F0F8FF">Department:</td>

<td>
    <select name="department" value="<?php echo set_select('department');?>">
    
                <option value="No Entry" selected>
                    «No Entry»
                </option>
                <option value="Department 01" selected>
                    Department 01
                </option>
                <option value="Department 02" selected>
                    Department 02
                </option>
...
<td>
  <input type="text" id="phone" name="phone" value="<?php echo set_value('phone');?>" style="width:300px" >  
</td>
</tr>
...
<tr>
    <td bgcolor="#D8DFE6" colspan="4">Display preferences</td>
</tr>
...
<tr>
  <td bgcolor="#F0F8FF" ><label>Display Name : </label></td>
  <td><input type="text" id="Display" name="DisplayName" value="<?php echo set_value('DisplayName');?>"  style="width:450px" ></td> 
</tr>
...
<!--
<tr><td bgcolor=" #F0F8FF">Profile Picture:</td>
  
     <td style="200px">

        <div id="image_display">
                
                <input type="hidden" name="profileImage" id="Image" value="<?php echo set_value('profileImage');?>"  />

                
                        <img id="profileImage" style="border:1px solid #a0a0a0" src="pro_pic.gif" alt="profile image" />
   ...
   <td>
        <label  bgcolor="#D8DFE6" >Choose File</label>
         <input type="text" id="file" name="file"  style="width:150px" placeholder ="No choosen file" value="<?php echo set_value('file');?>" >
         <br>
         <input id="clear_button" class="ed-btn" type="button" name ="Reset" value="Reset Image" onClick="removeImage();" />
    </td>
...
<tr><td bgcolor=" #F0F8FF">Email Notifications:</td>

<td>

<input type="radio" name="emailNotification" value="true" <?php echo set_radio('emailNotification', 'true', TRUE); ?> >Yes</input>&nbsp;&nbsp;
<input type="radio" name="emailNotification" value="false" <?php echo set_radio('emailNotification', 'false'); ?> checked="true">No</input>
...
<tr>
<td bgcolor=" #F0F8FF" >Time Zone:</td>

<td>
    <select name="timeZone" value="<?php echo set_select('timeZone');?>">
    
        <option value="NULL_CRITERIA" >Use Default</option>
        ...
        <option value="America/Argentina/San_Luis" >(GMT-04:00) America/Argentina/San_Luis</option>
        ...
        <option value="America/Porto_Acre" >(GMT-04:00) America/Porto_Acre</option>
        ...
        <option value="America/Argentina/ComodRivadavia" >(GMT-03:00) America/Argentina/ComodRivadavia</option>
        ...
        <option value="Africa/Timbuktu" >(GMT+00:00) Africa/Timbuktu</option>
        ...
        <option value="Europe/Belfast" >(GMT+00:00) Europe/Belfast</option>
    
        <option value="Europe/Dublin" >(GMT+00:00) Europe/Dublin</option>
    
        <option value="Europe/Guernsey" >(GMT+00:00) Europe/Guernsey</option>
    
        <option value="Europe/Isle_of_Man" >(GMT+00:00) Europe/Isle_of_Man</option>
        ...
        <option value="Asia/Istanbul" >(GMT+02:00) Asia/Istanbul</option>
        ...
        <option value="Australia/South" >(GMT+09:30) Australia/South</option>
    
        <option value="Australia/Yancowinna" >(GMT+09:30) Australia/Yancowinna</option>
        ...
        <option value="Australia/ACT" >(GMT+10:00) Australia/ACT</option>
        ...
        <option value="Australia/NSW" >(GMT+10:00) Australia/NSW</option>
        ...
        <option value="Australia/Tasmania" >(GMT+10:00) Australia/Tasmania</option>
    
        <option value="Australia/Victoria" >(GMT+10:00) Australia/Victoria</option>
        ...
        <option value="Australia/LHI" >(GMT+10:30) Australia/LHI</option>
...
<tr>
<td  bgcolor=" #F0F8FF">Date Format:
   
</td>
<td>
<select name="dateFormat" value="<?php echo set_select('dateFormat');?>">
...
<tr>
  <td bgcolor=" #F0F8FF"> <label> Subscription Admin: </label></td>
  <td><input type="checkbox"  name ="subscription" value="disable" <?php echo set_checkbox('subscription', 'disable'); ?> /></td> 
</tr>
...
<tr>  
  ...
  <td>
    <button style="width:120px" name="save_new">Save</button>
