...
<form class="form-iteration" role = "form" method = "post" action = "/Rally_CI/editProject/update">
...
<tr>
  <td  bgcolor="#FF0000"><label> Project Name  </label></td>
  <td>
...
<tr>
  <td bgcolor="#FF0000"> <label> State </label> </td>
...
<tr> 
  <td bgcolor="#FF0000"> <label> Time Zone </label> </td>
...
<tr> 
  <td bgcolor="#FF0000"> <label> Date Format </label> </td>
...
<tr> 
  <td bgcolor="#FF0000"> <label> Workdays </label> </td>
  <td> 
      <input type = "checkbox"
                 id = "chksuday"
