...
<form class="form-defect" role = "form" method = "post" action = "addDefect" enctype="multipart/form-data">
...
<table align = "center" border="0" style="width:auto" >
  ...
  <tr>
    ...
    <td>
      <input type="text" id="txt" name="project" value="<?php echo (isset($selected_project)) ? $selected_project : ''; ?>" class="form-control" style="width:450px; border: none; box-shadow: none" readonly>
    </td> 
  </tr>
  ...
  <tr><th bgcolor="#D63030" style="text-align:right;"><label style="color: FFFFFF"> State : &nbsp;</label></th>
    <td colspan="3"> 
  ...
  <tr><th bgcolor="#D63030" style="text-align:right;"><label style="color: FFFFFF"> Schedule State : &nbsp;</label></th>
    <td colspan="3"> 
      <table>
  </tr>
