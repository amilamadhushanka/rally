...
<html lang="en">
  <head>
    ...
    <script>
      function openWin()
      {
        window.open("http://localhost/rally/resetPassword.php","_blank","toolbar=yes, scrollbars=yes, resizable=yes, top=150, left=360, width=600, height=325");
      }
    </script>
  ...
  <body style="overflow:hidden;">
    ...
    <div class="container">
      ...
      <br><br><br><br><br><br>
      <form class="form-signin" role="form" method="post" action="/Rally_CI/login/login_user"  >
      ...
      -->
        ...
        <br>
        <center>
       <a href=<?php echo "'.base_url().'login/reset_password'.'"; ?> onclick="javascript:void window.open('fogotPassword','1393836897034','toolbar=yes, scrollbars=yes, resizable=no, top=180, left=330, width=700, height=290');
        return false;">Forgot your password?</a>
      </center>
      <br>
        <center><b>Not registered yet?</b>&nbsp;<a href="http://localhost/Rally_CI/register">Sign Up Here</a></center>
