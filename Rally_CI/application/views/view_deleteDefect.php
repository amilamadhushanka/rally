...
<form class="form-defect" role = "form" method = "post" action = "/Rally_CI/deleteDefect/delete" enctype="multipart/form-data" onSubmit="return confirm('Are you sure you want to delete this defect?')">
