...
<form class="form-defect" role = "form" method = "post" action = "viewTask_selectProject">
...
<table align = "center" border="0" style="width:auto" >
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td><select id="project" name="selectProject" required style="width:450px; height:30px;" onChange="changeFunc();">
