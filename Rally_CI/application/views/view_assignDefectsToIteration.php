  ...
  function loadDefects($project){
    ...
    while($row = mysql_fetch_array($result)){   //Creates a loop to loop through results
      ...
      echo "<tbody><tr class='alt'><td>" . $row['id'] . "</td><td>" . $row['name'] . "</td><td>" . $row['description'] . "</td><td>" . $row['planEstimate'] . "</td>
            <td>" . $row['priority'] . "</td><td><a href='http://localhost/Rally_CI/AssignedToIteration/get_values/". $row['id'] ."/". $row['project'] ."'> <img src='".base_url('assets\images\assign_icon.png')."'></img> </a></td></tr></tbody>";
    }
