...
<?php
  ...
  function loadIterationDetails($iteration){
    ...
    while($row = mysql_fetch_array($result)){   //Creates a loop to loop through results
      echo "<tbody><tr class='alt'><td>" . $row['ID'] . "</td><td>" . $row['name'] . "</td><td>" . $row['description'] . "</td><td>" . $row['Plan_estima'] . "</td><td>" . $row['state'] . "</td><td><a href='http://localhost/Rally_CI/assignedDF_US/remove/". $row['ID'] ."'>
