...
<h3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Delete Testcase</h3>



<form class="form-iteration" role = "form" method = "post" action = "/Rally_CI/deleteTestcase/delete" enctype="multipart/form-data" onSubmit="return confirm('Are you sure you want to delete this testcase?')" >
