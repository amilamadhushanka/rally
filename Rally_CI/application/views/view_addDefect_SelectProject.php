...
<head>
  <meta charset="utf-8">
    ...
    <script>
        function openWin()
        {
         window.open("http://localhost/Rally_CI/addDefect","_blank","toolbar=yes, scrollbars=yes, resizable=yes, top=10, left=175, width=1000, height=640");
        }
    </script>
...
<form class="form-defect" role = "form" method = "post" action = "addDefect_SelectProject">
...
<table align = "center" border="0" style="width:auto" >
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td><select id="project" name="select_project" required style="width:450px; height:30px;" onChange="changeFunc();" autofocus>
