<html>
    ...
    <body>
        ...
        <form class="form-defect" role = "form" method = "post" action = "newProject">
...
<tr>
  <td  bgcolor="#D63030" style="text-align:right;"><label style="color: FFFFFF"> Project Name : &nbsp;</label></td>
...
<tr>
  <td bgcolor="#D63030" style="text-align:right;"> <label style="color: FFFFFF"> State : &nbsp;</label> </td>
...
<tr> 
  <td bgcolor="#D63030" style="text-align:right;"> <label style="color: FFFFFF"> Time Zone : &nbsp;</label> </td>
...
<tr> 
  <td bgcolor="#D63030" style="text-align:right;"> <label style="color: FFFFFF"> Date Format : &nbsp;</label> </td>
...
<tr> 
  <td bgcolor="#D63030" style="text-align:right;"> <label style="color: FFFFFF"> Workdays : &nbsp;</label> </td>
  <td> &nbsp;
      <input type = "checkbox"
                 id = "chksuday"
