...
<form class="form-defect" role = "form" method = "post" action = "/Rally_CI/assignedToIteration/assign">
...
<table align = "center" border="0" style="width:auto" >
  ...
  <tr>
    <td bgcolor="#D63030" style="text-align:right;"><label style="color: FFFFFF">Defect : &nbsp;</label></td>
    <td>
