 ...
 <body style="overflow:hidden;">
  ...
  <div class="container" >
      ...
      <form class="form-signin" method="post" action="register">
        ...
        <a href=<?php echo "'.base_url().'agreement'.'"; ?> onclick="javascript:void window.open('agreement','1393836897034','toolbar=yes, scrollbars=yes, resizable=no, top=200, left=175, width=1000, height=250');
        return false;">CloneOfRally's Subscription Agreement</a><em style="color: red;">*</em>
        </label>
      ...
      <center><b>Already Registered? </b><a href=<?php echo "http://localhost/Rally_CI/login"; ?>>Sign in Here</a></center>
