<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	class AddTestcase_SelectProject extends CI_Controller{
		...
		public function index(){
			...
			if($this->form_validation->run()==FALSE){
				...
				$this->load->view('addTestcase_selectProject_view');
			}
			else{
				...
				if(isset($project)){
					$this->load->view('addTestcase_view', array('selected_project' =>$project )); 
				}
				else{
