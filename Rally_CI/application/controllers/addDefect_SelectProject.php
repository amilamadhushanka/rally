<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	class AddDefect_SelectProject extends CI_Controller{
		...
		public function index(){
			...
			if($this->form_validation->run()==FALSE){
				...
				$this->load->view('view_addDefect_SelectProject');
			}
			else{
				...
				if(isset($project)){
					$this->load->view('view_addDefect', array('selected_project' =>$project )); 
				}
				else{
