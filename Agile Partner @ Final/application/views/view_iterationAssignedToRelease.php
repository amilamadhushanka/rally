...
<form class="form-defect" role = "form" method = "post" action = "http://agilepartner.comxa.com/index.php/iterationAssignedToRelease/assign">
...
<table align = "center" border="0" style="width:auto" >
  ...
  <tr>
    ...
    <td>
      <input type="text" id="txt" name="iteration" value="<?php echo (isset($name)) ? $name : ''; ?>" class="form-control" style="width:450px; border: none; box-shadow: none" readonly>
    </td> 
  </tr>
  ...
  <tr>
    <td bgcolor="#2E64FE" style="text-align:right;"><label style="color: FFFFFF"> Release : &nbsp;</label></td>
    <td>
      <select name="release" style="width:450px;" required>
          <option value="" selected="true" style="display:none; ">«Select Release»</option>
         <?php 
          loadRelease($pname);
        ?>
      </select>
...
function loadRelease($se_project)
{
    $result = mysql_query("select name from release where project='$se_project'");
