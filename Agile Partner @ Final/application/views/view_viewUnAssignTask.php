    ...
    <table align = "left" border="0" style="width:auto">
      ...
      <tr> 
        <td>
          ...
          <br>
          <?php
            loadTask($_SESSION['project']); //get parsed value from controller
          ?>
        </td>
      </tr>
      <tr>
...
<?php
  ...
  function loadTask($selectedProject){
    ...
    $query = "SELECT * FROM newtask t  WHERE t.project_name='$selectedProject' AND t.owner IS NULL OR t.owner='' ";
...
while($row = mysql_fetch_array($result)){   //Creates a loop to loop through results
      ...
      <td>" . $row['description'] . "</td> <td><a href='http://agilepartner.comxa.com/index.php/Assign_UnAssignTask/get_values/". $row['task_name'] ."'>
