...
<form class="form-defect" role = "form" method = "post" action = "http://agilepartner.comxa.com/index.php/editEvent/update">
...
<table align = "center" border="0" style="width:auto" >
  ...
  <tr>
    ...
    <td>
      <table>
        <tr>
          <td>
            <input type="text" id="txt" name="txtName" class="form-control" style="width:450px" value="<?php echo $name; ?>" required autofocus>
          </td>
          <td>
  ...
  <tr>
    ...
    <td><TEXTAREA ROWS="10" COLS="30" id="ta" name="txtDescription" class="form-control form_element" style="width:450px;"><?php echo $description; ?></TEXTAREA></td> 
  </tr>
  ...
  <tr> <?php $today=date("Y-m-d"); ?>
    ...
    <td><input type="date" id="txtDate" name="txtDate" class="input-small" min="<?php echo $today; ?>" style="width:150px;height:30px;" value="<?php echo $date; ?>" required></td>
  </tr>
  <tr>
    <td bgcolor="#2E64FE" style="text-align:right;"><label style="color: FFFFFF"> Time : &nbsp;</label></td>
    <td>
      <input id="txtTime" name="txtTime" type="time" class="input-small" style="width:150px;height:30px;margin-top:5px;" value="<?php echo $time; ?>" required>
    </td>
  </tr>
</table>
</div>
