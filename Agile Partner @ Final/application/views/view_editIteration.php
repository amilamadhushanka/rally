...
<head>
  <meta charset="utf-8">
    ...
    <script type="text/javascript">
      function goBack(){
        url="http://agilepartner.comxa.com/index.php/plan";
...
<form class="form-iteration" role = "form" method = "post" action = "http://agilepartner.comxa.com/index.php/editIteration/update" >

<div style="height:370px; overflow:scroll; overflow-x:hidden; border:thin solid; border-color:DarkGray;">
...
<table align = "center" border="0" style="width:auto" >
  ...
  <tr>
    ...
    <td><TEXTAREA ROWS="10" COLS="30" id="ta" name="txtTheme" class="form-control form_element"> <?php echo $theme; ?> </TEXTAREA></td> 
  </tr>
  ...
  <tr> 
    <td>
      <input type="text" id="txtStartDate" name="txtStartDate" class="form-control" placeholder="Select a date" value="<?php echo $startDate; ?>">
    </td> 
    <td >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
         &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
         </td>
    ...
    <td>
      <input type="text" id="txtEndDate" name="txtEndDate" class="form-control" placeholder="Select a date" value="<?php echo $endDate; ?>">
    </td>
  </tr>
  ...
  <tr> 
    ...
    <td>
      <input type="text" id="txt" name="txtPlannedVelocity" class="form-control" value="<?php echo $PlannedVelocity; ?>">
    </td>
  </tr>
