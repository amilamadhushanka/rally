...
<h3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Userstory Details</h3>



<form class="form-defect" role = "form" method = "post" action = "http://agilepartner.comxa.com/index.php/editUserstory/update" enctype="multipart/form-data">
...
<table align = "center" border="0" style="width:auto" >
  ...
  <tr>
    ...
    <td><input type="text" id="name" name="name" class="form-control" style="width:450px; margin-top:5px;"  value="<?php echo $name; ?>" readonly></td>
  </tr>

  <tr>
    <td style="text-align:right;" bgcolor="#D8DFE6"><label> Rank : &nbsp;</label></td>
    <td><input type="text" id="rank" name="rank" class="form-control" style="width:450px; margin-top:5px;"  value="<?php echo $rank; ?>" readonly></td>
  </tr>

  <tr>
    <td style="text-align:right;" bgcolor="#D8DFE6"><label> Tags : &nbsp;</label></td>
    <td><input type="text" id="tags" name="tags" class="form-control" style="width:450px; margin-top:5px;"  value="<?php echo $tags; ?>" readonly></td>
  </tr>

  <tr>
    <td style="text-align:right;" bgcolor="#D8DFE6"><label> Description : &nbsp;</label></td>
    <td><TEXTAREA ROWS="10" COLS="30" id="description" name="description" class="form-control form_element" value="<?php echo $description; ?>" readonly></TEXTAREA></td> 
  </tr>
...
<tr><td style="text-align:right;" bgcolor="#D8DFE6"><label> Priority : &nbsp;</label></td>
  ...
  <tr> 
    <td>
      <input type="text" id="priority" name="priority" class="form-control" style="width:200px; margin-top:5px;"  value="<?php echo $priority; ?>" readonly></td>
    </td> 
  </tr>
</table>
  <tr>
  ...
  <tr><th bgcolor="#2E64FE" style="text-align:right;"><label style="color: #FFFFFF"> Scheduled State : &nbsp;</label></th>
    <td colspan="3"> 
  ...
  <tr> 
    <td>
      <input type="text" id="sch_state" name="sch_state" class="form-control" style="width:200px; margin-top:5px;"  value="<?php echo $sch_state; ?>" readonly></td>
    </td> 
  ...
  <tr> 
    ...
    <td><input type="text" id="txtBlockedReason" name="txtBlockedReason" class="form-control" style="width:200px" disabled value="<?php echo $blockedReason; ?>" readonly></td>
  </tr>
  ...
  <tr>
    ...
    <td>
      <input type="text" id="iteration" name="iteration" class="form-control" style="width:200px; margin-top:5px;"  value="<?php echo $iteration; ?>" readonly></td>
    </td> 
  </tr>

  <tr>
    <td style="text-align:right;" bgcolor="#D8DFE6"><label> Plan-Estima : &nbsp;</label></td>
    <td><input type="text" id="planEstima" name="planEstima" class="form-control" style="width:200px; margin-top:5px;"  value="<?php echo $planEstima; ?>" readonly></td>
  </tr>
