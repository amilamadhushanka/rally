...
<form class="form-defect" role = "form" method = "post" action = "http://agilepartner.comxa.com/index.php/assignedToIteration/assign">
...
<table align = "center" border="0" style="width:auto" >
  ...
  <tr>
    <td bgcolor="#2E64FE" style="text-align:right;"><label style="color: FFFFFF">Defect : &nbsp;</label></td>
    <td>
      <input type="text" id="txt" name="defect" value="<?php echo (isset($defect_id)) ? $defect_id : ''; ?>" class="form-control" style="width:450px; border: none; box-shadow: none" readonly>
    </td> 
  </tr>
  ...
  <tr>
    ...
    <td>
      <select name="iteration" style="width:450px; height:25px;" required autofocus>
