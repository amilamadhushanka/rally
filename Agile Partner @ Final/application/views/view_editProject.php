...
<html>
    ...
    <body>
        ...
        $changest=$row->changest;
        $user_story=$row->user_story;
        $defect=$row->defect;
        $tasks=$row->tasks;

        $chksuday = $workdays{0};
        $chkmonday = $workdays{1};
        $chktuesday = $workdays{2};
        $chkwednessday = $workdays{3};
        $chkthursday = $workdays{4};
        $chkfriday = $workdays{5};
        $chksaturday = $workdays{6};

        $changest = $changest{0};

        $str = str_replace(' ','',$project);
        echo "<br>";
...
<form class="form-iteration" role = "form" method = "post" action = "http://agilepartner.comxa.com/index.php/editProject/update">
...
<table align = "center" border="0" style="width:auto" >
 ...
 <tr>
  <td> <h4 class="form-signin-heading" > <font color ="#0000FF"> Edit Project </font> </h4></td>
  <td><?php echo date('l, F jS, Y'); ?> </td>
 </tr> 


<tr>
  <td  bgcolor="#2E64FE"><label> Project Name  </label></td>
  <td>


   
        <input type="text" id="txt" name="projectname" class="form-control" style="width:100px" value = "<?php echo $str; ?> " readonly > 
    </td> 
</tr>
...
<tr>
	...
	<td> <textarea name="description" rows="10" cols="80" class= "input" style="width:750;overflow:auto" id="_random_id_9" > <?php echo $discription; ?></textarea> </td>
</tr>

<tr>
  <td bgcolor="#2E64FE"> <label> State </label> </td>
  <td> <select id="db_sate" name = "state">
        ...
        <input type = "checkbox"
                 ...
                 value = "1" />
        <br>
        <input type="text" id="txt" name="txtState" class="form-control" style="width:90px"  value= "<?php echo $state; ?>" >
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <input type="text" id="txt" name="txtOwner" class="form-control" style="width:120px"  value= "<?php echo $owner; ?>" >
  </td>
...
<tr> 
  <td bgcolor="#2E64FE"> <label> Time Zone </label> </td>
  <td> <select id = "db_timezone" name = "timezone">
        ...
        <input type="text" id="txt" name="txttimezone" class="form-control" style="width:305px" value= "<?php echo $timezone; ?>" >
...
<tr> 
  <td bgcolor="#2E64FE"> <label> Date Format </label> </td>
  <td> <select id ="db_dataformat" name = "date_formate">
        ...
        <input type = "checkbox"
                 id = "chkdate_and_time_formate"
                 name = "check_date_and_time_formate"
                 value = "1" />

        <BR>
        <input type="text" id="txt" name="txtdateFormat" class="form-control" style="width:120px"  value= "<?php echo $date_format; ?>" >
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        &nbsp;&nbsp;
        <input type="text" id="txt" name="txtdateTimeFormat" class="form-control" style="width:180px"  value= "<?php echo $date_time_format; ?>" >
...
<tr> 
  <td bgcolor="#2E64FE"> <label> Workdays </label> </td>
  <td> 
      <input type = "checkbox"
                 id = "chksuday"
                 value = "1" name = "check_sunday" / <?php if ($chksuday == '1') echo "checked='checked'"; ?> >
             <label for = "chkEggs">Sunday</label>
           
             <input type = "checkbox"
                 id = "chkmonday"
                 name = "check_monday"
                 value = "1" / <?php if ($chkmonday == '1') echo "checked='checked'"; ?> >
             <label for = "chkHam">Monday</label>

             <input type = "checkbox"
                 id = "chktuesday"
                 name = "check_tuesday"
                 value = "1" / <?php if ($chktuesday == '1') echo "checked='checked'"; ?> >
             <label for = "chkEggs">Tuesday</label>
           
             <input type = "checkbox"
                 id = "chkwednessday"
                 name = "check_wednesday"
                 value = "1" / <?php if ($chkwednessday == '1') echo "checked='checked'"; ?> >
             <label for = "chkHam">Wednessday</label>

             <input type = "checkbox"
                 id = "chkThursday"
                 name = "check_thursday"
                 value = "1" / <?php if ($chkthursday == '1') echo "checked='checked'"; ?> >
             <label for = "chkEggs">Thuersday</label>
           
             <input type = "checkbox"
                 id = "chkfriday"
                 name = "check_friday"
                 value = "1" /  <?php if ($chkfriday == '1') echo "checked='checked'"; ?>>
             <label for = "chkHam">Friday</label>

             <input type = "checkbox"
                 id = "chksaturday"
                 name = "check_saturday"
                 value = "1" / <?php if ($chksaturday == '1') echo "checked='checked'"; ?>>
             <label for = "chkHam">Saturday</label>
  </td>

    <tr>
        <td> <label> Enable Build and Changest </label> </td>
...
<tr>
  <td> <lable> Work Product Prefixes </label> </td>
  <td> </td>
</tr>
...
<tr>
  <td><label> User Story  </label></td>
  <td><input type="text" id="txt" name="txtUserStory" class="form-control" style="width:750px" placeholder="US" value= "<?php echo $user_story; ?>" ></td> 
</tr>



<tr>
  <td><label> Defects  </label></td>
  <td><input type="text" id="txt" name="txtDfect" class="form-control" style="width:750px" placeholder="DF" value= "<?php echo $defect; ?>" ></td> 
</tr>
...
<tr>
  ...
  <td><input type="text" id="txt" name="txtTask" class="form-control" style="width:750px" placeholder="TS" value= "<?php echo $tasks; ?>"></td> 
</tr>
...
<tr>  
  ...
  <td>
    ...
    <button name = "save" style="width:120px">Save </button>
  </td>
</tr>
