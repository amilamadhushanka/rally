...
<form class="form-iteration" role = "form" method = "post" action = "http://agilepartner.comxa.com/index.php/deleteIteration/delete" onSubmit="return confirm('Are you sure you want to delete this iteration?')">
