    ...
    <script type="text/javascript">
      $(document).ready(function () {
        ...
        $.each(arrayOfPHPData, function (i, elem) {
          arrayOfDataJS[i] = [parseInt(elem['cnt']),elem['environment']];
        });
...
<body>
  ...
  <table>
    ...
    <tr>
      ...
      <td>&nbsp;&nbsp;<font size="6"><b>Defects by Environment</b></font>
        
        <font id="sort" style="margin-left:410px;"><b>Sort by :&nbsp;</b></font>
  ...
  <div style="width:1100px;" align="center">    
          <table border=1>
             <thead align='center'><tr>
              ...
              <th width='10%' style="text-align:center">ENVIRONMENT</th>

            </tr> </thead>
            <?php foreach ($defect as $row): ?>
            <?php echo "<tbody align='left'><tr class='alt'><td>" . $row['id'] . "</td><td>" . $row['description'] . "</td>
            <td>" . $row['priority'] . "</td><td>" . $row['severity'] . "</td><td>" . $row['iteration'] . "</td><td>" . $row['environment'] . "</td>
            </tr></tbody>";
            ?>
            <?php endforeach; ?>
            </table>
