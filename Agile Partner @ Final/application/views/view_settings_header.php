  ...
  <div class="container-fluid" >
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li ><a href="http://agilepartner.comxa.com/index.php/createTeam">USERS</a></li>
        <li ><a href="http://agilepartner.comxa.com/index.php/projects">WORKSPACES & PROJECTS</a></li>
        <li ><a href="http://agilepartner.comxa.com/index.php/download">VERSION TRACKING</a></li>
       ...
       <ul class="nav navbar-nav navbar-right">
        ...
        <li><a href="http://agilepartner.comxa.com/index.php/backlog"><?php echo "<img src='".base_url('assets\images\settings_icon.png')."'>"; ?></a></li>
        <li class="dropdown">
