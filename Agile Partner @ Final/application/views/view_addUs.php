...
<form class="form-defect" role = "form" method = "post" action = "http://agilepartner.comxa.com/index.php/us_controller" enctype="multipart/form-data">
...
<table align = "center" border="0" style="width:auto" >
  ...
  <tr><th style="text-align:right;" bgcolor="#D8DFE6"><label> State : &nbsp;</label></th> 
  ...
  <tr>
    ...
    <td>
      <select id="owner" name="owner" onChange="changeFunc();">
        <option value="noEntry" selected="true" style="display:none" >«No Entry»</option>
        <?php 
  ...
  <tr>
    <td bgcolor="#D8DFE6" style="text-align:right;"><label> Creation Date : &nbsp;</label></td>
    <td>
  ...
  <tr><td style="text-align:right;" bgcolor="#2E64FE"><label style="color: #FFFFFF"> Scheduled State : &nbsp;</label></td>
    <td colspan="3"> 
