    ...
    <script type="text/javascript">
      $(document).ready(function () {
        ...
        $.each(arrayOfPHPData, function (i, elem) {
          arrayOfDataJS[i] = [parseInt(elem['cnt']),elem['state']];
        });
...
<body>
  ...
  <table>
    ...
    <tr>
      ...
      <td>&nbsp;&nbsp;<font size="6"><b>Defects by State</b></font>
        
        <font id="sort" style="margin-left:470px;"><b>Sort by :&nbsp;</b></font>
...
<br><br>
  ...
  <div style="width:1100px;" align="center">    
          <table border=1>
            ...
            <td>" . $row['priority'] . "</td><td>" . $row['severity'] . "</td><td>" . $row['iteration'] . "</td><td>" . $row['state'] . "</td>
            </tr></tbody>";
            ?>
            <?php endforeach; ?>
            </table>
