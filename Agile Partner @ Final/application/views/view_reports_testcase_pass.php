    ...
    <script type="text/javascript">
      function changeFunc() {
        ...
        if(selectedValue=="TC_id"){
          window.location.href ="http://agilepartner.comxa.com/index.php/reportsTestcasesPass/load/"+selectedProject+"/TC_id"
        }
        else if(selectedValue=="USid"){
          window.location.href ="http://agilepartner.comxa.com/index.php/reportsTestcasesPass/load/"+selectedProject+"/USid"
        }
        else if(selectedValue=="IterationName"){
          window.location.href ="http://agilepartner.comxa.com/index.php/reportsTestcasesPass/load/"+selectedProject+"/IterationName"
        }
        else if(selectedValue=="LastRun"){
          window.location.href ="http://agilepartner.comxa.com/index.php/reportsTestcasesPass/load/"+selectedProject+"/LastRun"
        }
        else if(selectedValue=="LastBuilt"){
          window.location.href ="http://agilepartner.comxa.com/index.php/reportsTestcasesPass/load/"+selectedProject+"/LastBuilt"
        }
      }
  </script>
...
<body>
  ...
  <table>
    ...
    <tr>
      ...
      <td>&nbsp;&nbsp;<font size="6"><b>Passed Test Case Report</b></font>
